...
def getCookie(account, password):
    if COOKIE_GETWAY == 0:
        ...
        logger.info("COOKIE_GETWAY Error!")
        pass
...
def get_cookie_from_weibo_cn(account, password):
    ...
    browser=''
    try:
        browser = webdriver.PhantomJS(executable_path='E:\\mac\\id\\phantomjs-2.1.1-windows\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe',desired_capabilities=dcap)
